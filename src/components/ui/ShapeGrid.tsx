...
const ShapeGrid = ({
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (event: MouseEvent) => {
      ...
      let newHovered: { x: number; y: number } | null = null;

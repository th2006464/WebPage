type TranslationDict = Record<string, Record<string, Record<string, string>>>;
...
const translations: TranslationDict = {
  home: {
    en: {
      ...
      heroTagline: 'PRIVATE HOLDINGS',
      heroLine1: 'Quiet Capital.',
      heroLine2: 'Generational Vision.',
      ...
      copyright: '© 2026 FOXTANG International Holdings',
      brandTagline: 'Private Holdings',
    },
    zh: {
  ...
  about: {
    en: {
      ...
      sectionHowWeWork: 'How We Work',
      sectionHowWeWorkDesc: 'Quiet presence. Stewardship first. Every engagement measured by a single standard.',
      valueDiscretion: 'Discretion',
      valueDiscretionDesc: 'We move quietly. Our principals\' affairs remain private, their interests protected, their names absent from the record.',
      valuePatience: 'Patience',
      valuePatienceDesc: 'We measure returns in decades. Our structures are built to outlast the conditions that created them.',
      valueStewardship: 'Stewardship',
      valueStewardshipDesc: 'Guiding portfolio companies with the patience and perspective that only private, unconflicted capital can offer.',
    ...
    zh: {
      ...
      sectionHowWeWork: '工作方式',
      sectionHowWeWorkDesc: '安静的存在。守护为先。每项合作只经一项标准衡量。',
      valueDiscretion: '审慎',
      valueDiscretionDesc: '我们悄然行事。投资人的事务始终私密，利益始终受护，名字永不公开。',
      valuePatience: '耐心',
      valuePatienceDesc: '以十年丈量回报。我们的架构，比催生它们的时代更持久。',
      valueStewardship: '守护',
      valueStewardshipDesc: '以只有私人、无利益冲突的资本才能提供的耐心与视角，为组合公司领航。',
  ...
  capabilities: {
    en: {
      ...
      sectionServicesDesc: 'What we deliver — discreetly, precisely, without fanfare.',
      sectionCoreCompetencies: 'Core Competencies',
      sectionCoreCompetenciesDesc: 'Disciplines we bring to every engagement — precise, private, purposeful.',
      sectionStats: 'Impact by the Numbers',
      sectionStatsDesc: 'A quiet footprint with disproportionate influence.',
      statTransactions: 'Transactions Executed',
      statJurisdictions: 'Jurisdictions Covered',
      statCapital: 'Capital Under Stewardship',
      statTransactionsVal: '200+',
      statJurisdictionsVal: '15+',
      statCapitalVal: '$2.8B+',
      sectionApproach: 'Our Approach',
      approachTitle: 'Discretion by Design',
      approachDesc: 'Every capability we deploy is wrapped in a framework of privacy. We structure engagements so that our principals\' identities, intentions and interests remain protected — across every jurisdiction, at every stage.',
      statPrivate: 'Private',
      statOversight: 'Oversight',
      statPublicity: 'Publicity',
      contactTitle: 'Contact', contactBody: 'For confidential inquiries and private partnerships, we may be reached through the channel below.',
      copyright: '© 2026 FOXTANG International Holdings',
      brandTagline: 'Private Holdings',
    },
    zh: {
      ...
      sectionServicesDesc: '我们交付的——审慎、精准、无声。',
      sectionCoreCompetencies: '核心能力',
      sectionCoreCompetenciesDesc: '每次合作中携带的专业素养——精准、私密、有目的。',
      sectionStats: '数据概览',
      sectionStatsDesc: '安静的存在，不成比例的影响。',
      statTransactions: '已完成交易',
      statJurisdictions: '覆盖司法辖区',
      statCapital: '托管资本规模',
      statTransactionsVal: '200+',
      statJurisdictionsVal: '15+',
      statCapitalVal: '$2.8B+',
      ...
      approachTitle: '设计即审慎',
      approachDesc: '我们部署的每一项能力都包裹在隐私框架之中。我们构建的合作架构确保投资人的身份、意图与利益在每一个司法辖区、每一个阶段都受到保护。',
      statPrivate: '私有',
      statOversight: '监督',
      statPublicity: '公开',
      contactTitle: '联系', contactBody: '机密咨询与私人合作，请通过下方渠道联系。',
  ...
  portfolio: {
    en: {
      ...
      sectionPhilosophy: 'Investment Philosophy',
      sectionPhilosophyDesc: 'Three pillars that define every allocation decision.',
      pillarEndurance: 'Endurance',
      pillarEnduranceDesc: 'We seek assets that compound through cycles, not headlines. Durability matters more than velocity.',
      pillarDiversification: 'Diversification',
      pillarDiversificationDesc: 'Across continents, jurisdictions, and asset classes — insulation from any single point of failure.',
      pillarPrivacy: 'Privacy',
      pillarPrivacyDesc: 'Structures designed to protect ownership, preserve control, and keep our principals\' interests confidential.',
      sectionClasses: 'Asset Classes',
      sectionClassesDesc: 'A disciplined allocation across enduring categories.',
      sectionDomains: 'Domains',
      sectionDomainsDesc: 'Where we deploy our capital — selectively, deliberately, quietly.',
      sectionAllocation: 'Allocation Philosophy',
      allocEquity: 'Core Equity',
      allocInfra: 'Infrastructure',
      allocTech: 'Technology Platforms',
      metricContinents: 'Continents',
    ...
    zh: {
      ...
      sectionPhilosophy: '投资哲学',
      sectionPhilosophyDesc: '三根支柱，定义每一次配置决策。',
      pillarEndurance: '耐久',
      pillarEnduranceDesc: '我们寻找能穿越周期复利的资产，而非追逐头条。韧性比速度更重要。',
      pillarDiversification: '多元',
      pillarDiversificationDesc: '跨越大洲、司法辖区与资产类别——隔绝任何单点故障。',
      pillarPrivacy: '隐私',
      pillarPrivacyDesc: '保护所有权、维系控制权、确保投资人利益机密的架构设计。',
      sectionClasses: '资产类别',
      sectionClassesDesc: '在经久不衰的品类中，执行纪律严明的配置。',
      sectionDomains: '投资领域',
      sectionDomainsDesc: '我们部署资本之处——精选、审慎、安静。',
      sectionAllocation: '配置哲学',
      allocEquity: '核心股权',
      allocInfra: '基础设施',
      allocTech: '技术平台',
      metricContinents: '大洲',
